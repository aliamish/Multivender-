...
const DashboardHero = () => {
  ...
  return (
    <div className="w-full p-8">
      ...
      <div className="w-[97%] block 800px:flex items-center justify-between">
        <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
          ...
          <h5 className="pt-2 pl-[36px] text-[23px] font-[500]">
            ${availableBalance}
          </h5>
      ...
      <div className="w-[93%] mx-8 pt-1 mt-10 bg-white">
        <DataGrid
          rows={row}
          columns={columns}
          pageSize={10}
